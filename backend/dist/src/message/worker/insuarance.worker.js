...
class ClaimsWorker {
            ...
            await channel.consume(MAIN_QUEUE, async (msg) => {
                ...
                try {
                    ...
                    if (routingKey === "claim.created") {
                        await this.handleClaimCreated(data);
                    }
                    ...
                    console.error(`[Claims Worker Error] Failed processing ${routingKey}:`, error);
    ...
    async handleClaimCreated(payload) {
        console.log(`\n--- [EVENT] claim.created ---`);
        console.log(`Claim ID: ${payload.claimId} | Claim #: ${payload.claimNumber}`);
